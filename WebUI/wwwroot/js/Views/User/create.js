    ...
    $('#organization-select').on('change', function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#division-select').append('<option disabled selected>Выберите подразделение</option>');
                $('#position-select').append('<option disabled selected>Выберите должность</option>');
                $('#district-select').append('<option disabled selected>Выберите район</option>');
